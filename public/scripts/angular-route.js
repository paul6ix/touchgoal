...
// They are initialized inside the `$RouteProvider`, to ensure `window.angular` is available.
    ...
    var ngRouteModule = angular.module('ngRoute', []).info({angularVersion: '1.7.2'}).provider('$route', $RouteProvider).// Ensure `$route` will be instantiated in time to capture the initial `$locationChangeSuccess`
